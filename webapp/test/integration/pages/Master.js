				...
				actions : {
					...
					iRememberAnIdOfAnObjectThatsNotInTheList : function () {
						return this.waitFor(this.createAWaitForAnEntitySet({
							entitySet : "ProductAvailabilityCollection",
							success : function (aEntityData) {
								this.waitFor({
									...
									success : function (oList) {
										...
										oCurrentItem.bindingPath = "/" + oList.getModel().createKey("ProductAvailabilityCollection", {
				...
				assertions : {
					...
					theListHeaderDisplaysZeroHits : function () {
						return this.waitFor({
							viewName : sViewName,
							id : "page",
							matchers : new PropertyStrictEquals({name : "title", value : "ProductAvailabilityCollection (0)"}),
							success : function () {
								Opa5.assert.ok(true, "The list header displays 'ProductAvailabilityCollection (0)'");
							},
					...
					theListShouldHaveAllEntries : function () {
						...
						// retrieve all ProductAvailabilityCollection to be able to check for the total amount
						...
						return this.waitFor({
							...
							success : function (oList) {
								...
								this.waitFor({
									id : "page",
									viewName : sViewName,
									matchers : new PropertyStrictEquals({name : "title", value : "ProductAvailabilityCollection (" + iExpectedLength + ")"}),
									success : function () {
